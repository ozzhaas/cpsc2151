...
public class GameScreen {
    ...
    public static void main(String[] args) {
        ...
        List<Character> playerArray1 = new ArrayList<>();
        ...
        while (playAgain) {
            ...
            for (int j = 1; j <= numOfPlayers; j++) {
                ...
                System.out.println("Player " + playerArray1.get(j - 1) + " please enter your ROW:");
                String mainRow = scan.nextLine();
                System.out.println("Player " + playerArray1.get(j - 1) + " please enter your COLUMN:");
                String mainCol = scan.nextLine();
                mainPos = new BoardPosition(Integer.parseInt(mainRow),
                        Integer.parseInt(mainCol));
                mainPos = move(scan, mainPos, playerArray1.get(j - 1), mainBoard);
                mainBoard.placeMarker(mainPos, playerArray1.get(j - 1));
                if (mainBoard.checkForWinner(mainPos)) {
                    System.out.println(mainBoard);
                    System.out.println("Congratulations Player " + playerArray1.get(j - 1) + "! You won!\n");
                ...
                /***********************************************************************************************
                 * Check for a draw since there was no win
                 **********************************************************************************************/
    ...
    public static BoardPosition move (Scanner scan, BoardPosition playersMove, char player, IGameBoard moveBoard){
        ...
        System.out.println("playersMove is: " + moveBoard.checkSpace(playersMove));
        if (!moveBoard.checkSpace(playersMove)) {
